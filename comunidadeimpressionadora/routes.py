...
from comunidadeimpressionadora.forms import FormLogin, FormCriarConta, FomrEditarPerfil, FormCriarPost
...
def editar_perfil():
    ...
    if form.validate_on_submit():
        ...
        if form.foto_perfil.data:
            nome_imagem = salvar_iamgem(form.foto_perfil.data)
